...
<form class="form-horizontal" role="form">
  <div class="form-group">
    ...
    <div class="col-lg-10">
      <div class="radio">
  <label><input type="radio" name="opTipoDisparo">Uno por uno</label>
</div>
<div class="radio">
  <label><input type="radio" name="opTipoDisparo">Rafaga</label>
</div>
    </div>
  </div>
  <div class="form-group">
...
<div class="radio">
  ...
  <div class="form-group">
    <div class="col-lg-offset-2 col-lg-10">
        ...
        <input type="button" value="Nuevo Juego">
